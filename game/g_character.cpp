...
constexpr string::literal names[] = {
    "aaron",        "alice",        "ash",          "алексе́й",      "عباد",
    "brian",        "bertha",       "blix",         "богдан",       "بشار",
    "charlie",      "carol",        "cyrix",
    "david",        "dani",         "dash",         "дми́трий",      "داود",
    "evan",         "eve",          "erok",
    "frank",        "francie",      "flyx",         "фёдор",        "فيصل",
    "george",       "gina",         "guuak",        "георгий",      "غفار",
    "henry",        "haley",        "han",                          "حامد",
    "ian",          "isabel",       "ix",           "игорь",        "اسحاق",
    "jack",         "joan",         "jaxon",                        "جعفر",
    "kevin",        "katrina",      "kyris",        "кирилл",       "خالد",
    "larry",        "liz",          "lox",                          "لطيف",
    "mike",         "mary",         "mazen",        "максим",       "معاذ",
    "neil",         "nancy",        "noz",          "никола",       "نسیم‎",
    "oscar",        "olivia",       "orlan",        "олег",         "عمر",
    "pete",         "patty",        "pax",          "павел",
    "quigley",      "quinn",        "qaam",                         "قاسم",
    "roger",        "rachel",       "rip",          "роман",        "رشيد",
    "steve",        "sarah",        "shep",         "саша",         "سمير",
    "tom",          "traci",        "tosh",                         "طارق",
    "ulf",          "uma",          "ug",                           "عثمان",
    "victor",       "violet",       "vok",          "вадим",
    "walter",       "wendy",        "wuax",                         "وليد",
    "xavier",       "xena",         "xav",
    "yuri",         "yvette",       "yael",         "яков",         "يوسف",
    "zack",         "zoey",         "zinn",         "зиновий",      "زيد",
};
