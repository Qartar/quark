...
constexpr string::literal names[] = {
    "aaron",        "alice",        "ash",          "алексе́й",      "αλέξιος",      "عباد",    "אדם",       "あきら",
    "brian",        "bertha",       "blix",         "богдан",                       "بشار",    "בנימין",    "べにこ",
    "charlie",      "carol",        "cyrix",                        "χάρις",                                "ちよこ",
    "david",        "dani",         "dash",         "дми́трий",      "δαμιανός",     "داود",    "דניאל",     "だいき",
    "evan",         "eve",          "erok",                         "ηλίας",                    "אליהו",    "えいた",
    "frank",        "francie",      "flyx",         "фёдор",                        "فيصل",                 "ふみこ",
    "george",       "gina",         "guuak",        "георгий",      "γιώργος",      "غفار",    "גבריאל",    "ごう",
    "henry",        "haley",        "han",                          "ομηρος",       "حامد",                 "はるか",
    "ian",          "isabel",       "ix",           "игорь",        "ιωάννης",      "اسحاق",   "יצחק",      "いつき",
    "jack",         "joan",         "jaxon",                        "ιάσων",        "جعفر",    "יעקב",
    "kevin",        "katrina",      "kyris",        "кирилл",       "κόκος",        "خالد",                 "かおり",
    "larry",        "liz",          "lox",                          "λουκας",       "لطيف",    "לוי",
    "mike",         "mary",         "mazen",        "максим",       "μάρκος",       "معاذ",    "מיכאל",     "めぐみ",
    "neil",         "nancy",        "noz",          "никола",       "νίκος",        "نسیم‎",    "נתנאל",    "なおみ",
    "oscar",        "olivia",       "orlan",        "олег",         "ορέστης",      "عمر",                  "おさむ",
    "pete",         "patty",        "pax",          "павел",        "πάρις",                    "פנחס",
    "quigley",      "quinn",        "qaam",                                         "قاسم",
    "roger",        "rachel",       "rip",          "роман",                        "رشيد",     "ראובן",    "りょう",
    "steve",        "sarah",        "shep",         "саша",         "σίμων",        "سمير",     "שמעון",    "しげる",
    "tom",          "traci",        "tosh",                         "θάνος",        "طارق",     "טוביה",    "つよし",
    "ulf",          "uma",          "ug",                                           "عثمان",    "אורי",
    "victor",       "violet",       "vok",          "вадим",        "βασίλης",
    "walter",       "wendy",        "wuax",                                         "وليد",
    "xavier",       "xena",         "xav",
    "yuri",         "yvette",       "yael",         "яков",         "γιάννης",      "يوسف",     "יוחנן",    "ゆうま",
    "zack",         "zoey",         "zinn",         "зиновий",      "ζωιλος",       "زيد",      "זבולון",
};
