...
public:
    shield(physics::shape const* base, game::ship* owner, int compartment);
    ~shield();
...
protected:
    ...
    static constexpr float recharge_rate = 1.f / 20.f; //!< strength per second per unit of module power
