...
buffer::PFNGLCREATEBUFFERS buffer::glCreateBuffers = nullptr;
buffer::PFNGLNAMEDBUFFERDATA buffer::glNamedBufferData = nullptr;
buffer::PFNGLNAMEDBUFFERSUBDATA buffer::glNamedBufferSubData = nullptr;
buffer::PFNGLMAPNAMEDBUFFER buffer::glMapNamedBuffer = nullptr;
    ...
    , _data(nullptr)
{
    if (glCreateBuffers && glNamedBufferData) {
        ...
        glNamedBufferData(_name, _size, data, gl_buffer_usage(_usage, _access));
    } else {
...
void buffer::upload(GLintptr offset, GLsizeiptr size, void const* data) const
{
    if (glNamedBufferSubData) {
        glNamedBufferSubData(_name, offset, size, data);
